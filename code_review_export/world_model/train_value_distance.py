...
def main():
    ...
    ap.add_argument("--ae", default=AE_WEIGHTS,
                    help="AE weights used to encode frames. Pass "
                         "ae_predictive.pth to retrain the value head on the "
                         "P2b latent (also set a new --out so you keep both).")
    args = ap.parse_args()
    ...
    print(f"Encoding frames (frozen encoder: {args.ae})...")
